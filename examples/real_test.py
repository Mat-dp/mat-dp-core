...
electronics_producer = processes.create("electronics_producer", (electronics, +1))
...
print(constraints)
# Minimise run total
objective = concrete_producer + steel_producer + aluminium_producer + electronics_producer + wind + solar + coal + energy_producer
