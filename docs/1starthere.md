...
### Project Context
Welcome to the MAT-DP Core. This repository sits at the 'core' of a wider project to deliver user-friendly and open-access software solutions to environment and energy researchers.  
